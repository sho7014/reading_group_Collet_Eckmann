...
\subsection{4.10. (WIP)}
This answer greatly relies on~\cite{beyn1998numerical} but somewhat concretized. 
\vskip 1.0em
...
\end{equation}
Let us denote $A_{\rm s}:= D_{\rm s}f^{\rm s}(0), A_{\rm u}:= D_{\rm u}f^{\rm u}(0)$. By definition $\sigma_{A_{\rm s}}$ (resp. $\sigma_{A_{\rm u}}$) is included inside (resp. outside) the unit circle, where $\sigma_A$ is the spectrum of $A$.  
\vskip 1.0em
